    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                     <form method="POST" action="{{ url('/addProfile') }}" aria-label="{{ __('Profile') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="profile_pic" type="file" class="form-control-file{{ $errors->has('profile_pic') ? ' is-invalid' : '' }}" name="profile_pic" required>
